        ...
        <div className="grid grid-cols-1 lg:grid-cols-[400px_1fr] gap-8">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-lg p-6">
            ...
            <div className="flex gap-3 mb-6">
              ...
              <button
                onClick={handleShare}
                className="flex items-center gap-2 px-4 py-2 border-2 border-gray-300 dark:border-slate-600 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700 transition"
